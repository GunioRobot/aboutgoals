...
describe FeaturesController do
  ...
  describe "GET index" do
    it "assigns all features as @features" do
      Feature.stub(:find).with(:all).and_return([mock_feature])
      get :index
  ...
  describe "GET show" do
    it "assigns the requested feature as @feature" do
      Feature.stub(:find).with("37").and_return(mock_feature)
      get :show, :id => "37"
  ...
  describe "POST create" do
    ...
    describe "with valid params" do
      it "assigns a newly created feature as @feature" do
        Feature.stub(:new).with({'these' => 'params'}).and_return(mock_feature(:save => true))
